...
proc vTcl:prefs:init {base} {
    ...
    set tb [ttk::notebook $base.tb]
    pack $tb -fill both -expand 1

    $tb add [ttk::frame $tb.f1] -text "Basics"
    $tb add [ttk::frame $tb.f2] -text "Project"
    $tb add [ttk::frame $tb.f3] -text "Fonts"
    $tb add [ttk::frame $tb.f4] -text "Colors"
    $tb add [ttk::frame $tb.f5] -text "Images"
    $tb add [ttk::frame $tb.f6] -text "Libraries"
    
    vTcl:prefs:basics  $tb.f1
    vTcl:prefs:project $tb.f2
    vTcl:prefs:fonts   $tb.f3
    vTcl:prefs:bgcolor $tb.f4
    vTcl:prefs:images  $tb.f5
    vTcl:prefs:libs    $tb.f6
...
proc vTclWindow.vTcl.prefs {{base ""}} {
    ...
    ttk::radiobutton $base.rb -text "Single line"
...
proc {vTcl:prefs:basics} {tab} {
	...
	vTcl:formCompound:add $tab ttk::checkbutton \
	...
	set entry [vTcl:formCompound:add $form_entry ttk::entry \
...
proc {vTcl:prefs:bgcolor} {tab} {
    ...
    vTcl:formCompound:add $tab ttk::radiobutton \
    ...
    set last [vTcl:formCompound:add $tab ttk::radiobutton \
...
proc {vTcl:prefs:images} {tab} {
	...
	vTcl:formCompound:add $tab ttk::label \
		-text "Editor for images"

	set form_entry [vTcl:formCompound:add $tab frame]
	pack configure $form_entry -fill x

	set last [vTcl:formCompound:add $form_entry ttk::entry  \
