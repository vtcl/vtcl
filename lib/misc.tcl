...
proc vTcl:boolean_radio {path args} {
    eval ttk::radiobutton $path $args
  ...
  proc encode {text} {
    ...
    proc decode {text} {
        ...
        for {set i 0} {$i < $lenx } {incr i} {
            ...
            if { [expr $i % 4 ] == 3}  {
                append decoded [binary format c [expr $y >> 16 ]]
                append decoded [binary format c [expr ( $y & 0x00ff00 ) >> 8 ]]
                append decoded [binary format c [expr ( $y & 0x0000ff ) ]]
                set y 0
            }
        }
...
proc ::vTcl::BrowseButton {path args} {
    ttk::button $path -image [vTcl:image:get_image browse.gif]
    eval $path configure $args
}
...
namespace eval ::vTcl::ui::attributes {
    ...
    proc newAttribute {target top option variable config_cmd check_cmd keyrelease_cmd} {
        ...
        switch $type {
            boolean {
                frame $base
                ttk::radiobutton ${base}.y -variable $variable -value 1 -text "Yes" -relief sunken -command "$config_cmd
                $keyrelease_cmd $option $variable ::vTcl::ui::attributes::checked($base)" -padx 0 -pady 1
                ttk::radiobutton ${base}.n -variable $variable -value 0 -text "No" -relief sunken -command "$config_cmd
                $keyrelease_cmd $option $variable ::vTcl::ui::attributes::checked($base)" -padx 0 -pady 1
            ...
            choice {
                ttk::combobox ${base} -editable 0 -width 12 -values $choices -modifycmd "vTcl:prop:choice_select ${base} $variable; $config_cmd
            ...
            color {
                ...
                trace variable $variable w "::vTcl::ui::attributes::show_color ${base}.f $variable"
            ...
            default {
                vTcl:entry $base -textvariable $variable -width 12 -highlightthickness 1 -relief flat
                lappend enableData ${base}
            }
        }
