...
proc vTcl:font:init_stock {} {
    ...
    # stock fonts
    vTcl:font:add_font "-family Monospace -size 12"              stock
    vTcl:font:add_font "-family Monospace -size 12 -underline 1" stock underline
    vTcl:font:add_font "-family courier -size 12"                stock
    vTcl:font:add_font "-family times -size 12"                  stock
    vTcl:font:add_font "-family Monospace -size 12 -weight bold" stock
...
proc vTclWindow.vTcl.fontManager {args} {
    ...
    vTcl:toolbar_button $base.butfr.but30 \
        -command {set font_desc "-family {Monospace} -size 12"
