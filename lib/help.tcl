...
proc vTclWindow.vTcl.tip {base} {
    ...
    ttk::checkbutton $base.fra20.che26 \
        -text {Don't show tips on startup} -variable ::tip::dontshow 
    ttk::button $base.fra20.but19 \
        \
        -command {
    ...
    ttk::button $base.fra20.but20        -command {
                  TipWindow.TipText configure -state normal
                  TipWindow.TipText delete 0.0 end
    ...
    frame $base.fra23 \
        -borderwidth 2 
    ttk::label $base.fra23.lab24 \
        -borderwidth 1 \
        -image light_bulb \
        -relief flat -text label 

    ScrolledWindow $base.cpd25
    text $base.cpd25.03 -font {Monospace 10} -height 1 -relief flat
    $base.cpd25 setwidget $base.cpd25.03

    label $base.lab19 \
        -borderwidth 1 -font {Monospace 14} \
        -text {Did you know ...?} 
    ###################
    # SETTING GEOMETRY
    ###################
...
namespace eval ::vTcl::news {
   ...
   proc ::vTcl::news::display_news {token} {
      ...
      font create link -family Monospace -size 10 -underline 1
   ...
   proc ::vTcl::news::parse_news {base string} {
      ...
      foreach line $lines {
         ...
         switch -- $command {
            "News"	{
               set l [label $base.f.t.link$i -text $text -background white -foreground blue -font link -cursor hand1]
