...
proc compoundCmd {target} {
    ...
    ttk::frame $target -height 30 -width 30 
    ...
    ttk::scrollbar $site_3_0.02  -command "$site_3_0.01 xview" -orient horizontal 
    vTcl:DefineAlias "$site_3_0.02" "Scrollbar3" vTcl:WidgetProc "Toplevel1" 1
    ttk::scrollbar $site_3_0.03  -command "$site_3_0.01 yview" 
...
proc compoundCmd {target} {
    ...
    set site_3_0 $target
    ttk::scrollbar $site_3_0.01  -command "$site_3_0.03 xview" -orient horizontal 
    vTcl:DefineAlias "$site_3_0.01" "Scrollbar1" vTcl:WidgetProc "Toplevel2" 1
    ttk::scrollbar $site_3_0.02  -command "$site_3_0.03 yview" 
...
proc compoundCmd {target} {
    ...
    set parent [join [lrange $items 0 end-1] .]
    set top [winfo toplevel $parent]
    ttk::frame $target  -borderwidth 1 -height 182 -width 222 
    vTcl:DefineAlias "$target" "Frame2" vTcl:WidgetProc "Toplevel1" 1
    set site_3_0 $target
    ttk::scrollbar $site_3_0.01  -command "$site_3_0.03 xview" -orient horizontal 
    ...
    canvas $site_3_0.03  -borderwidth 2 -closeenough 1.0 -height 100 -highlightthickness 1  -relief sunken -width 100 -xscrollcommand "$site_3_0.01 set" -yscrollcommand "$site_3_0.02 set" -bg #202024
